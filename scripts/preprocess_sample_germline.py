...
required_args.add_argument("-methy", "--methy", help="Please provide the path of methylation information", required=True)
opt_args.add_argument("-m", "--menu", help="menu of paired WGS label and WGBS data")
