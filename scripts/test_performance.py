...
required_args.add_argument("-i", "--input", help="Relative or direct path to CBSuiTe predict result.", required=True)
required_args.add_argument("-g", "--gold", help="Relative or direct path to gold standard.", required=True)
required_args.add_argument("-o", "--output", help="Summary output excel name.")
...
for i, sample_name in enumerate(samples):
    ...
    print("ecole_calls_data: ", ecole_calls_data.shape)
